 ...
 * for credibility; framing the same value as "what people use Takara for"
...
const USE_CASES = [
  ...
  },
  {
    ...
    body: "Explain the concept back to a Tutor persona — if you can't, you don't know it yet. Takara hears the gaps.",
  },
  {
    icon: Languages,
  ...
  },
  {
    ...
    body: "Voice-draft an essay, a memo, or an email. Takara plays editor and pushes back on weak claims.",
  },
  {
    icon: Sparkles,
    title: "Just thinking out loud",
    body: "Some sessions don't need a topic. Takara listens, reflects, and helps the idea find its own shape.",
  },
]
  ...
  return (
    ...
    >
      <div className="max-w-2xl mb-12 sm:mb-16">
        ...
        Takara isn&apos;t prescriptive — it adapts to whatever you bring to the
