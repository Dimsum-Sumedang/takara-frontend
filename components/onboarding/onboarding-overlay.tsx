...
/**
 * Interactive first-run tour that mirrors Takara's visual language —
...
const STEPS: Array<{
  ...
  {
    title: (name) => `Hi ${name.split(" ")[0]}, meet Takara.`,
    description:
  ...
  },
  {
    ...
    description:
      "Pitch a startup, prep an interview, rehearse a toast, work out a stoic reflection — Takara rolls with it. Pick a persona to set the tone.",
    hint: "Tap a chip or type your own",
  },
  {
    title: () => "Hold space, then speak.",
    description:
      "Takara listens until you pause, replies in voice, and you can cut in at any time. On mobile, hold the orb. On desktop, hold the spacebar.",
...
/* ─── Step 1 — meet Takara (idle orb + floating sparkles) ─── */
...
function Step3Visual({ orbSize }: { orbSize: number }) {
  ...
  return (
    <div className="grid place-items-center gap-4">
      ...
      >
        {phase === "listening" ? "You're speaking…" : "Takara replies…"}
      </p>
    </div>
  )
}
