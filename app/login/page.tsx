...
const ONBOARDING_STORAGE_PREFIX = "takara_onboarding_v1"

const PENDING_OTP_EMAIL_KEY = "takara_pending_otp_email"
const PENDING_OTP_TIME_KEY = "takara_pending_otp_time"
const PENDING_OTP_MODE_KEY = "takara_pending_otp_mode"
    ...
    <PhoneShell size="wide">
      <header className="px-4 sm:px-8 pt-5 sm:pt-6 pb-2">
        ...
        <BrandLogo size={32} priority />
          <span className="text-[15px] font-semibold tracking-tight">Takara</span>
        </Link>
      </header>
