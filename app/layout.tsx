...
export const metadata: Metadata = {
  title: "Takara — AI voice assistant",
  description:
  ...
  // shared links.
  icons: {
    icon: "/takara-logo.jpg",
    shortcut: "/takara-logo.jpg",
    apple: "/takara-logo.jpg",
  },
  openGraph: {
    title: "Takara — AI voice assistant",
    description:
      "A premium AI voice assistant that listens, thinks, and replies — in real time.",
    images: [{ url: "/takara-logo.jpg", width: 1024, height: 1024, alt: "Takara" }],
    type: "website",
  },
  twitter: {
